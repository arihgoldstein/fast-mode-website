          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-12 pt-8 border-t border-white/5">
              ...
              <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-70 hover:opacity-100 transition-all duration-500">
                ...
                <img src="/images/logos/replit.svg" alt="Replit" className="h-6 object-contain brightness-0 invert" />
                <img src="/images/logos/windsurf.svg" alt="Windsurf" className="h-6 object-contain brightness-0 invert" />
