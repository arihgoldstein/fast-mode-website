        ...
        <section className="relative overflow-hidden py-16 sm:py-24">
          ...
          <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-8">
              <span className="block text-white mb-2 leading-tight">AI Built Your Website.</span>
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-violet-400 pb-2 leading-tight">
            ...
            <div className="mt-12 pt-8 border-t border-white/5">
              ...
              <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-16 opacity-70 hover:opacity-100 transition-all duration-500">
                ...
                <img src="/images/logos/lovable.svg" alt="Lovable" className="h-4 sm:h-5 object-contain brightness-0 invert" />
                <img src="/images/logos/claude.svg" alt="Claude" className="h-5 sm:h-6 object-contain brightness-0 invert" />
                <img src="/images/logos/replit.svg" alt="Replit" className="h-20 sm:h-24 object-contain brightness-0 invert" />
