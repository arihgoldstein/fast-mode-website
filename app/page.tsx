          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex h-[600px] md:h-[700px] rounded-2xl overflow-hidden">
                  ...
                  <div className="w-64 bg-slate-950 border-r border-white/5 flex-col flex-shrink-0 hidden lg:flex">
                    <div className="p-4 flex items-center gap-2 border-b border-white/5 h-14">
                      <svg className="h-4" viewBox="0 0 253 142" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M182.377 141.045H70.5226C31.5732 141.045 0 109.472 0 70.5226C0 31.5732 31.5732 0 70.5226 0H182.377C221.327 0 252.9 31.5732 252.9 70.5226C252.9 109.472 221.327 141.045 182.377 141.045Z" fill="#6062EE"/>
                        <path d="M182.377 120.816C210.154 120.816 232.671 98.2992 232.671 70.5224C232.671 42.7455 210.154 20.229 182.377 20.229C154.601 20.229 132.084 42.7455 132.084 70.5224C132.084 98.2992 154.601 120.816 182.377 120.816Z" fill="#F9F9F9"/>
                      </svg>
                  ...
                  <div className="w-64 bg-slate-900 border-r border-white/5 flex-col flex-shrink-0 hidden xl:flex">
                     ...
                     <div className="p-3">
                        <div className="flex items-center gap-2 mb-4 bg-slate-950 border border-white/10 rounded-lg px-3 py-2">
                           <Search className="w-4 h-4 text-slate-500 shrink-0" />
                           <span className="text-sm text-slate-500">Search pages...</span>
                        </div>
            ...
            <div className="mt-12 pt-8 border-t border-white/5">
              ...
              <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 opacity-70 hover:opacity-100 transition-all duration-500">
                <img src="/images/logos/cursor.svg" alt="Cursor" className="h-5 max-w-[120px] object-contain brightness-0 invert" />
                <img src="/images/logos/lovable.svg" alt="Lovable" className="h-5 max-w-[120px] object-contain brightness-0 invert" />
                <img src="/images/logos/claude.svg" alt="Claude" className="h-5 max-w-[120px] object-contain brightness-0 invert" />
                <img src="/images/logos/replit.svg" alt="Replit" className="h-5 max-w-[120px] object-contain brightness-0 invert" />
                <img src="/images/logos/windsurf.svg" alt="Windsurf" className="h-5 max-w-[120px] object-contain brightness-0 invert" />
                <img src="/images/logos/google-ai-studio.svg" alt="Google AI Studio" className="h-5 max-w-[140px] object-contain brightness-0 invert" />
              </div>
            </div>
          </div>
        </section>
