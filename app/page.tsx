                        ...
                        <div className="w-full h-full bg-white text-slate-900 flex flex-col">
                           ...
                           <div className="relative flex-1 flex items-center justify-center p-4 lg:p-8 overflow-hidden">
                              ...
                              <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center">
                                 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-[10px] lg:text-xs text-blue-700 mb-8 font-bold uppercase tracking-wide">
                                    <span className="flex h-1.5 w-1.5 rounded-full bg-blue-600"></span>
                                    Voted #1 Agency by my Mom
                                 </div>
                                 
                                 <div className="relative group mb-8">
                                    {/* Editor UI Overlay - Floating Toolbar */}
                                    <div className="absolute -top-14 left-1/2 -translate-x-1/2 bg-slate-900 text-white rounded-lg shadow-xl flex items-center p-1.5 gap-1 z-20 scale-90 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                       ...
                                       <div className="flex items-center gap-1.5 px-2 py-1 hover:bg-white/10 rounded cursor-pointer text-indigo-300">
                                    ...
                                    <h1 className="text-4xl lg:text-7xl font-sans font-bold leading-[1.1] tracking-tight text-slate-900">
                                       ...
                                       <span className="relative inline-block mt-2">
                                          <span className="bg-blue-100/50 ring-2 ring-blue-500/30 rounded px-2 py-1">That Go Brrr.</span>
                                          {/* Cursor & User Label */}
                                          <div className="absolute -right-0.5 top-1 bottom-1 w-0.5 bg-blue-600 animate-pulse"></div>
                                          <div className="absolute -right-3 top-full mt-2 flex items-center gap-2">
